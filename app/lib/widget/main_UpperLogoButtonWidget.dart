...
class Widget_UpperLogoButton extends StatelessWidget {
  ...
  Widget_UpperLogoButton(
      {Key? key, required this.teamName, required this.routingFor})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    switch (routingFor) {
      case "inputScore":
        {
          viewLogoIndex = Function_GetTeamLogoPathIndex(nextMatchData.opponent);
          break;
        }
      case "favTeamInfo":
        {
          viewLogoIndex = Function_GetTeamLogoPathIndex(teamName);
          break;
        }
      default:
        {
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Page_inputScore(
                              deviceHeight,
                              deviceWidth,
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Page_confirmTeamInfo(
                              deviceHeight, deviceWidth, teamName)));
                },
                child: Container(
                  height: deviceHeight * 0.15,
                  width: deviceWidth * 0.4,
